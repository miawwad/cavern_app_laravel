...
<body>
    <div class="container-fluid">
        ...
        <form name="myForm" action="http://blackstone.roanoke.edu/mohammad/cavern_app/cavern/process_order.php" onsubmit="return validateForm()"
            method="post">
            ...
            <div id="options">
                <div class="grid-2">
                    ...
                    <div class="grid-item">
                        ...
                        <select name="entree" id="entree" class="form-select" aria-label="Default">
                            ...
                            <option id="sandwich" class="sandwich" value="Spicy Chicken Sandwich">Spicy Chicken Sandwich
                            </option>
                            ...
                            <option id="wrap" class="wrap" value="Crispy Chicken Wrap">Crispy Chicken Wrap</option>
                            ...
                            <option id="wrap" class="wrap" value="Grilled Chicken Wrap">Grilled Chicken Wrap</option>
                ...
                <div class="grid-item">
                    ...
                    <label for="Lettuce" class="form-check-label">
                        <input for="Lettuce" type="checkbox" id="Lettuce" class="form-check-input">Lettuce<br>
                    </label><br>
                    ...
                    <label for="Red Onion" class="form-check-label">
                        <input for="Red Onion" type="checkbox" id="Red Onion" class="form-check-input">Red Onion<br>
                    </label><br>
                    <label for="Pickels" class="form-check-label">
                        <input for="Pickels" type="checkbox" id="Pickels" class="form-check-input">Pickels<br>
                    </label><br>
                    <label for="Cucumbers" class="form-check-label">
                        <input for="Cucumbers" type="checkbox" id="Cucumbers" class="form-check-input">Cucumbers<br>
                    </label>
                </div>
                ...
                <div class="grid-item">
                    ...
                    <label for="American" class="form-check-label">
                        <input name="cheese" Type="radio" id="American" value="American" class="form-check-input">American<br>
                        
                    </label><br>
                    <label for="Provolone" class="form-check-label">
                        <input name="cheese" Type="radio" id="Provolone" value="Provolone" class="form-check-input">Provolone<br>
                    </label>
                    <br><br>
                ...
                <hr>
                <div id="btn">
                <button type="submit-order" value="submit" class="btn btn-primary">Place Order</button>
            </div>
                <hr>
            </div>
        </form>
